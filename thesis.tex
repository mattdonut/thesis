...
The internal force on the microtubule can come from a variety of sources (tension, stiffness, physical pinning, etc) external to the fluid behavior. 
...
These forces are used as the source terms with the Oseen tensor to calculate the fluid velocity field which determines the motion of the entire system.
