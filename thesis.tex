...
Within this plane, the anchors have a charateristic seperation, and this seperation defines one of the new length scales in the system.
The plane of anchors is parallel to the hard wall, but not directly on it. 
The seperation between the hard wall and the plane of anchors is a second new length scale.
...
\caption{ 
An image taken with a two photon microscope of a Drosophila ooctye during fast streaming. The Oocyte was treated so that the microtubules would flores and traces of them can be seen. In the regions of fast fluid motion, the microtubules can be seen to align with the direction of the fluid motion. [*** thank Bill and Corey ***]
}
\label{fig:biostream}
\end{center}
\end{figure}
