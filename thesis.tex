...
The internal force on the microtubule can come from a variety of sources (tension, stiffness, physical pinning, etc) external to the fluid behavior. The force on the impeller is entirely due to the connection to the microtubule through its local kinesin motor. Newton's third law requires that this force have a coresponding oposite acting on the microtubule, which is then also translated into the fluid. 
