...
Here we report the development of an analytic expression for the dependance of the radius of gyration of a polymer suspended in vacuum to its angular momentum.
We show the agreement of that expression with dynamic simulations using an angular momentum conserving system of rigid links.
