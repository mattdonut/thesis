...
\caption{ 
A typical configuration after correlation. The microtubules on the edges of the patch can be seen to execute a helical pattern reminecent of the single microtubule dynamics.
}
